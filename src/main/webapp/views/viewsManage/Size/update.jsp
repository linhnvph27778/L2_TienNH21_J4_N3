...
<div class="Container">
    <div class="col-11 mt-3 mx-5">
        <sf:form method="post" action="${view}" modelAttribute="CLSize">
            <div class="row mt-3">
                <div class="col-6">
                    <label>Mã:</label><br/>
                ...
                <div class="col-6">
                    <label>Số Size: </label><br/>
                    <sf:select path="soSize" cssClass="form-select">
                        <sf:option value="38"/>38
                        <sf:option value="39"/>39
                        <sf:option value="40"/>40
                        <sf:option value="41"/>41
                        <sf:option value="42"/>42
                    </sf:select>
                </div>
            </div>
            <div class="row mt-3">
