...
<div class="col-6 offset-3 mt-3">
    ...
    <div class="col-4 offset-4 mt-4">
        <form action="/loai-khach-hang/search" method="get">
            <div class="mt-2">
            ...
            <div class="mt-3">
                ...
                <a class="btn btn-success" href="/loai-khach-hang/viewAdd">Add</a>
            </div>
        </form>
    </div>
        ...
        <tbdoy>
            <c:forEach items="${list.content}" var="nv" >
                <tr>
                    ...
                    <td>${nv.soDiem}</td>
                    <td>
                        <a onclick="xacNhan(event)" href="/loai-khach-hang/delete/${nv.id}" class="btn btn-danger">Xoa</a>
                        <a href="/loai-khach-hang/viewUpdate/${nv.id}" class="btn btn-primary">Update</a>
                    </td>
                </tr>
            </c:forEach>
        </tbdoy>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <c:forEach begin="0" end="${ list.totalPages -1}" varStatus="loop">
                    <li class="page-item">
                        <a class="page-link" href="/loai-khach-hang/hien-thi?page=${loop.begin + loop.count - 1}">
