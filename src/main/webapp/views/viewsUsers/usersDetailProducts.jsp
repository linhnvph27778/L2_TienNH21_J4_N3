        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3">
                <div class="header__nav__option">
                    <a href="#" class="search-switch"><img src="/icon/search.png" alt=""></a>
...
<section class="shop-details">
    <form object="${product}" action="/viewsUsers/usersShop/addToCart/${product.id}"  method="post" >
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <div style="border-radius:10px;" class="product__thumb__pic set-bg" data-setbg="@{'"/img/product/ ${product.images_Product.image_Product_1}"></div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">
                                    <div style="border-radius:10px;" class="product__thumb__pic set-bg" data-setbg="/img/imgsProducts/'${product.images_Product.image_Product_2}"></div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">
                                    <div style="border-radius:10px;" class="product__thumb__pic set-bg" data-setbg="/img/imgsProducts/${product.images_Product.image_Product_3}"></div>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-4" role="tab">
                                    <div style="border-radius:10px;" class="product__thumb__pic set-bg" data-setbg="/img/imgsProducts/${product.images_Product.image_Product_4}"></div>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="/img/product/${product.images_Product.image_Product_1}"/>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="/img/imgsProducts/'${product.images_Product.image_Product_2}"/>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-3" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="/img/imgsProducts/${product.images_Product.image_Product_3}"/>
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-4" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="/img/imgsProducts/${product.images_Product.image_Product_4}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            <div class="product__details__cart__option">
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <input th:data-max-quantity="${product.remaining_product}" id="quantityInput" type="text" value="1">
                                    </div>
                                </div>
