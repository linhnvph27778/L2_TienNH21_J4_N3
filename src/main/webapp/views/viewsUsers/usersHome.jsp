...
<%--                    <div class= "col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix" th:class="'col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix ' + ${product.category_Product.ma_Category}">--%>
<%--                        <div class="product__item">--%>
<%--                            <div class="product__item__pic set-bg" style="border-radius:20px;"  th:attr="data-setbg=@{'img/product/' + ${product.images_Product.image_Product_1} + '.jpg'}">--%>
